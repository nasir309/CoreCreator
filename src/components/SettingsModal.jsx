    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <div className="flex items-center space-x-4 mb-4">
                <div className="relative group">
                  <img 
                    src={user?.avatar} 
                    alt={user?.name}
                    className="w-12 h-12 sm:w-16 sm:h-16 rounded-full border-2 border-gray-200 dark:border-gray-600 object-cover cursor-pointer transition-all group-hover:opacity-75"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 mt-2">
                    <button
                      ...
                      className="text-xs bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 text-white px-2 py-1 sm:px-3 sm:py-1 rounded-lg transition-colors flex items-center space-x-1"
                    >
                    ...
                    <button
                      ...
                      className="text-xs bg-gray-500 hover:bg-gray-600 text-white px-2 py-1 sm:px-3 sm:py-1 rounded-lg transition-colors"
                    >
                      Remove
                    </button>
                  </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <Sun className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-yellow-500" />
          ...
          {/* About Section */}
          <div className="space-y-4">
            <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white">About</h3>
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
